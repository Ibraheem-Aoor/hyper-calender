                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::text('start_date', $date ?? null, ['placeholder' => 'Select Start Date','class'=>'form-control form-control-sm datePicker']) }}
                            </div>
                            <div class="form-group">
                                {{ Form::label('end_date', __('End Date'),['class'=>'col-form-label col-form-label-sm']) }}
                                {{ Form::text('end_date', $date ?? null, ['placeholder' => 'Enter End Date','class'=>'form-control form-control-sm datePicker']) }}
                            </div>
                            <div class="form-group">
